...
class Model(nn.Module):
    def __init__(self, args, size_z=128, global_feature_size=1024):
        ...
        # print('ENcoder_PARA')
        # get_para(self.encoder)
        # print('posterior_infer1')
        # get_para(self.posterior_infer1)
        # print('posterior_infer2')
        # get_para(self.posterior_infer2)
        # print('prior_infer')
        # get_para(self.prior_infer)
        # print('generator')
        # get_para(self.generator)
        # print('DECODER_PARA')
        # get_para(self.decoder)
        # exit(0)
    ...
    def forward(self, x, gt=None, prefix="train", mean_feature=None, alpha=None):
        ...
        if prefix=="train":
            ...
            # print('q_distribution',q_distribution.size())
            # print('zq',z_q.size())
        ...
        if prefix=="train":
            ...
            # print('emd,',emd)
            # print('cd_p',cd_p)
            # return coarse_raw, fine,  emd,  cd_p,  cd_t,  f1
